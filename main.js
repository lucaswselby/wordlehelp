for (let i = 1; i <= 5; i++) {
    ...
    document.getElementById(`letter${i}`).oninput = () => {
        ...
        for (let i = 0; i < 26; i++) {
            document.getElementsByClassName("keyboardLetter")[i].style.visibility = "visible";
        }
        for (let i = 1; i <= 5; i++) {
            if (document.getElementById(`letter${i}`).value) {
                document.getElementById(document.getElementById(`letter${i}`).value).style.visibility = "hidden";
            }
        }
    };
...
document.getElementById("submit").onclick = () => {
    ...
    let yellow = [];
    for (let i = 1; i <= 5; i++) {
        if (document.getElementById(`letter${i}Color`).value == 2) {
            green += document.getElementById(`letter${i}`).value;
        }
        else {
            green += "*";
        }
        if (document.getElementById(`letter${i}Color`).value == 1 && !yellow.includes(document.getElementById(`letter${i}`).value)) {
            yellow.push(document.getElementById(`letter${i}`).value);
        }
    }
...
// resets the wordle letters and keyboard
document.getElementById("reset").onclick = () => {
    for (let i = 1; i <= 5; i++) {
        document.getElementById(`letter${i}`).value = "";
        document.getElementById(`letter${i}`).style.backgroundColor = "#787C7E";
        document.getElementById(`letter${i}Color`).value = "0";
    }
    alphabet.forEach(letter => {
